...
\crefname{Stelling}{Stelling}{Stelling}
\crefalias{theorem}{Stelling}
...
\begin{enumerate}[(a).]
  ...
  \begin{itemize}
    ...
    \item 
    \begin{shortclaim} 
      $R$ is symmetrisch. Dat wil zeggen als $a\,R\,b$, dan $b\,R\,a$. 
    \end{shortclaim}
    \begin{proof} $ $ \newline
      Neem aan $a\,R\,b$. \newline
  ...
  \begin{proof} $ $ \newline
    Volgens \textbf{\cref{theorem2}.} geldt $a\,R\,b$ dan en slechts dan als 
    $a \equiv b \pmod{pq}$. 
