...
\begin{enumerate}[(a).]
    ...
    \begin{equation}
        \begin{split}
            t = \frac{h}{v+c}\ +\sqrt{\frac{h^{2}}{\left(v+c\right)^{2}}-\frac{l^{2}}{v^{2}-c^{2}}}\  \\
            \lor \:
            t = -\frac{h}{v-c}+\sqrt{\frac{h^{2}}{\left(v-c\right)^{2}}-\frac{l^{2}}{v^{2}-c^{2}}}  
        \end{split}
    \end{equation}
    ...
    \begin{equation}
        \begin{split}
            \left. t' = \sqrt{1 - \frac{v^2}{c^2}} \middle/ \left[\frac{h}{v+c} +
            \sqrt{\frac{h^{2}}{\left(v+c\right)^{2}}-\frac{l^{2}}{v^{2}-c^{2}}}\right] \right.\\
            \lor \:
            \left. t' = \sqrt{1 - \frac{v^2}{c^2}} \middle/ \left[-\frac{h}{v-c}+
            \sqrt{\frac{h^{2}}{\left(v-c\right)^{2}}-\frac{l^{2}}{v^{2}-c^{2}}}\right] \right.
        \end{split}
    ...
    \begin{equation}
        \begin{split}
            t' = \frac{h}{c}\sqrt{\frac{c-v}{c+v}}+
            \frac{1}{c}\sqrt{h^{2}\left(\frac{c-v}{c+v}\right)+l^{2}}\\
            \lor \:
            t' = \frac{h}{c}\sqrt{\frac{\left(c+v\right)}{c-v}}+
            \frac{1}{c}\sqrt{h^{2}\frac{\left(c+v\right)}{\left(c-v\right)}+l^{2}}
        \end{split}
    \end{equation}
